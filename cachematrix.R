...
## The two functions below can be used to create a special object that stores a matrix 
...
## 2) The function 'cacheSolve' below computes the inverse of the special "matrix"
